...
- Utilize a [query](DDL.sql) na schema para criar a base de dados. A schema deve ser chamada exatamente `sistema_pedidos` para corresponder à configuração da classe Conexao. Caso queira utilizar outro nome, atualize o final da URL de conexão no código.
